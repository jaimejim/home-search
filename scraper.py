...
def scrape_and_generate(url_file, csv, map):
    ...
    for _, row in df_new.iterrows():
        ...
        <b>Maintenance charge:</b> {Hoitovastike}<br>
        <b>Capital charge:</b> {Pääomavastike}<br>
        <b>Special charge:</b> {Erityisvastike}<br>
        <b>Total company charge:</b> {Yhtiövastike yhteensä}<br>
